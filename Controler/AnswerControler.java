...
public class AnswerControler extends HttpServlet {
	...
	SubjectOperation subo1=new SubjectOperation();
	 ...
	 String wrong_right="wrong";
	 String question_type=q.getQuestion_type();
	 if(question_type.equals("optional"))
	 {
		 if(submit_answer.equals(q.getAnswer_text()))
		 {
			 wrong_right="right";
		 }
	...
	Answer ans=new Answer(sub2,st,q,submit_answer,wrong_right,date);
