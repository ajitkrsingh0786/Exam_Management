	...
	<div class="question">
		...
		%><div>
			<form action="AnswerControler" method="post">
				...
				<div style="width: 80%; margin-left: 10%; margin-right: 0">
		...
		<%
				...
				if (size1 > 0 && i == 0) {
		%><h1>
			You have already given the test: (<a
				href="Result.jsp?sub_id=<%=sub_id%>">see the result</a>)
		</h1>
		<%
			}
				if (size1 == 0) {
		%><h1>There is no any qestion is added for this subject contact
			to admin</h1>
		<%
			}
