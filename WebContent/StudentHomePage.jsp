...
<body bgcolor="lightcyan">
	...
	<div class="available">
		<form name="forms" onsubmit="return subject()" action="AddSubjectControl" method="get">
			...
			<table id="mytab1">
				...
				%>
				<tr>
					<td><input type="checkbox" name="container"value="<%=subject.getSub_id()%>"> 
					<label
			...
			<table>
				...
				<tr>
					<td><input type="checkbox"  value="<%=sb1.getSub_id()%>"> 
						<input type="hidden" name="container2" value="<%=sb1.getSub_id()%>">
